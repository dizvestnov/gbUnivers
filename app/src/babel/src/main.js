...
window.onload = function () {
	...
	(function createSite() {
		...
		const headerSearchDropdown = new Header('a', 'navbarDropdown btn-dropdown search-dropdownButton', headerSearchItem[0], '#', 'Browse').render();
		...
		const headerSearchDropdownMenu = new Header('div', 'dropdown-menu', headerSearchItem[0]).render();
		...
		const headerSearchDropdownMenuItems = [
			...
			new Header('div', 'dropdown-divider', headerSearchDropdownMenu).render().setAttribute('role', 'separator'),
			...
			new Header('div', 'dropdownMarginTop', headerSearchDropdownMenu).render(),
		...
		const headerSearchFormInput = new Form('input',
			...
			'Search').init();
		const headerSearchFormButton = new Form('button', 'btn btn-outline-success search-button form-submit', headerSearchForm, 'submit').init();
		const headerSearchFormButtonFa = new Header('i', 'fas fa-search search-fa', headerSearchFormButton).render();
